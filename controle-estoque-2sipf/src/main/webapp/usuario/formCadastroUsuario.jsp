...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item"><a class="nav-link"
						href="/estoque/admin/dashboard.jsp">Voltar ao Dashboard</a></li>
	...
	<div class="container mt-5">
		...
		<form action="../cadastroUsuario" method="post" class="mt-4">
			...
			<!-- Seleção do Perfil -->
			<div class="mb-3">
				<label for="perfil" class="form-label">Perfil</label> <select
					class="form-control" id="perfi" name="perfil" required>
